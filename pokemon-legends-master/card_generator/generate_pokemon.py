...
def add_encounter_icon(img, stats):
    ...
    if stats.encounter_tier in ('recruit', 'Officers', 'rboss'):
        icon_img = get_img(ASSETS_DIR / 'encounter_icons' / 'Rocket.png', xy(2, 2))
    elif stats.encounter_tier in 'trainer':
        icon_img = get_img(ASSETS_DIR / 'encounter_icons' / 'Trainer.png', xy(2, 2))
    else:
