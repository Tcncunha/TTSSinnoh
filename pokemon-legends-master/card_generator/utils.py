...
def read_cube_shirne(cube_name='shrine_cube', sheet_name='Shrine'):
    shined = pd.read_excel(ROOT_DIR / f'{cube_name}.xlsx', sheet_name)
    return shined


def get_img(file_path: object, size: object) -> object:
